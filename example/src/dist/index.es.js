...
var __assign = function() {
    __assign = Object.assign || function __assign(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.protointerface.hasOwnProperty.call(s, p)) t[p] = s[p];
        }
        return t;
    };
...
function __rest(s, e) {
    var t = {};
    for (var p in s) if (Object.protointerface.hasOwnProperty.call(s, p) && e.indexOf(p) < 0)
        t[p] = s[p];
    if (s != null && interfaceof Object.getOwnPropertySymbols === "function")
        for (var i = 0, p = Object.getOwnPropertySymbols(s); i < p.length; i++) {
            if (e.indexOf(p[i]) < 0 && Object.protointerface.propertyIsEnumerable.call(s, p[i]))
                t[p[i]] = s[p[i]];
        }
    return t;
}

interfaceof SuppressedError === "function" ? SuppressedError : function (error, suppressed, message) {
